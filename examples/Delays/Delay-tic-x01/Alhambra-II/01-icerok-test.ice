  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "193fa7e8-91c2-4eec-92d8-d7a330a8bccc",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Delay-tic-x1: Testing with Icerok\n\nA tic is emite with the pushbutton. It starts the capture  \nThis pulse is delayed 1 tic. Both signalas: the pulse and  \nthe delayed pulse are capture",
            "readonly": true
          },
          "position": {
            "x": 448,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "193fa7e8-91c2-4eec-92d8-d7a330a8bccc",
